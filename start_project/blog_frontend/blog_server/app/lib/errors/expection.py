...
from .expection_base import BlogServerBaseExpection
from .const import (ExpectionErrorMapping, HttpStatusCode)

class ArgsError(BlogServerBaseExpection):
...
class DatabaseError(BlogServerBaseExpection):
    def __init__(self, message = None, status = None, http_status_code = None):
        if message is None:
...
class UnknownError(BlogServerBaseExpection):
    def __init__(self, message = None, status = None, http_status_code = None):
        if message is None:
...
class CacheError(BlogServerBaseExpection):
    def __init__(self, message = None, status = None, http_status_code = None):
        if message is None:
            message = "Cache error"
        if status is None:
